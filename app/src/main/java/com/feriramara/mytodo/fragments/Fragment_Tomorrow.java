...
public class Fragment_Tomorrow extends Fragment {
    ...
    private MySampleFabFragment dialogFrag;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ImageView imageView = v.findViewById(R.id.lazy_cat2);

        final ExplosionField ef = ExplosionField.attach2Window(getActivity());

        final FloatingActionButton buttonAddNote = v.findViewById(R.id.button_add_note_2);
        ...
        final RecyclerView recyclerView = v.findViewById(R.id.recycler_view_2);
        ...
        if (sortByDate) {
            noteViewModel.getTomorrowNotesByDate().observe(this, new Observer<List<Note>>() {
                @Override
